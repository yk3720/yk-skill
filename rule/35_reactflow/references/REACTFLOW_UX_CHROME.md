...
| 枠線太さ | [`VISUAL_DESIGN_RULES.md`](../../25_design_ux/VISUAL_DESIGN_RULES.md) §2 と整合 |
...
| ノード枠の太さ・色 | `FLOW_NODE_FRAME_WIDTH` / `FLOW_NODE_DIAMOND_STROKE_WIDTH`（**2px** · 菱形は `miter`）· [`VISUAL_DESIGN_RULES.md`](../../25_design_ux/VISUAL_DESIGN_RULES.md) §2 |

...
**最終更新:** 2026-06-24（四層パス · `docs/` 正本 · flowchart-studio UI パス）  
...
| ボタン・ダイアログ・ナビ・表 chrome class | `frontend/src/components/flowchart/flowchartUiClasses.ts`（`fcBtn*` · `fcTable*` · `fcColorLegend*` · バナー · `fcFitViewOptions`） |

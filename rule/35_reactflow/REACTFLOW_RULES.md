...
**入口（人間・エージェント）:** [`docs/design-system.md`](c:/yk-tool/flowchart-web-reactflow/docs/design-system.md) — レイヤー A〜E · 変更マップ · Phase 1–2

| 項目 | SSOT |
|------|------|
| スタイルガイド索引 | `flowchart-web-reactflow/docs/design-system.md` |

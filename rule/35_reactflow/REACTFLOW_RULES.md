...
| 左ナビ幅（デスクトップ PanelGroup） | **18% default · 160px min · 28% max · 48px collapsed**（`flowchart-studio:workspace-outer-v1`） |
| 表｜プレビュー（デスクトップ PanelGroup） | **40% : 60%（400px min : 280px min）**（`flowchart-studio:workspace-inner-v1`）|

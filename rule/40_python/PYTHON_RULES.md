...
**Git hook / CI（`flowchart-web-reactflow` 等）:** Ruff · pre-commit の機械ゲートと hook 失敗時のエージェント行動 → [`../60_tooling/QUALITY_GATE_RULES.md`](../60_tooling/QUALITY_GATE_RULES.md) §4 · §5。本 §7 は **設計・監査の人手チェックリスト**。

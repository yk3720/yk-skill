...
<#
.SYNOPSIS
  Deploy yk-skill claude-global/CLAUDE.md to %USERPROFILE%\.claude\CLAUDE.md
...
param(
    ...
    [string] $Source = '',
    [string] $Target = (Join-Path $env:USERPROFILE '.claude\CLAUDE.md')
)
...
Write-Host "Done. Restart Claude Code not required."

...
SSOT: `c:/yk-skill/rule/15_project_mgmt/APP_PROJECT_RULES.md` §4–§8 · `c:/yk-skill/rule/15_project_mgmt/PROJECT_DOCUMENT_RULES.md`（No 25）§7 · §11 · §12
...
| 4 | 企画フォルダ **最小 3 種** | `01_要求定義/` · `04_リポジトリ構造/` · `05_開発ガイドライン/`（[PROJECT_DOCUMENT_RULES §7](c:/yk-skill/rule/15_project_mgmt/PROJECT_DOCUMENT_RULES.md)） |
| 5 | 企画ルート `README.md` | 再開 3 ファイル · サブフォルダ索引 |
| 6 | `01_要求定義/プロジェクト概要.md` | 一文 · やる/やらない |
| 7 | `01_要求定義/MVP定義.md` または `完成チェックリスト.md` | 受け入れ条件が測定可能（AC 表 · [PROJECT_DOCUMENT_RULES §10.2](c:/yk-skill/rule/15_project_mgmt/PROJECT_DOCUMENT_RULES.md)） |
...
**講座提出プロジェクトのみ追加:** `00_テーマ/`（`テーマ.md` · `選定表_記入稿.md`）— [PROJECT_DOCUMENT_RULES §12.2](c:/yk-skill/rule/15_project_mgmt/PROJECT_DOCUMENT_RULES.md)

**任意（§12 トリガー後）:** `02_機能設計/` · `03_技術仕様/` · `06_ユビキタス言語/` · `99_アーカイブ/`

**MUST NOT（新規）:** ルート `AGENTS.md` — 憲法は `05_開発ガイドライン/エージェント憲法.md` のみ（[PROJECT_DOCUMENT_RULES §4](c:/yk-skill/rule/15_project_mgmt/PROJECT_DOCUMENT_RULES.md)）
...
| 8 | **6 種移行**（任意 · 成熟時） | [PROJECT_DOCUMENT_RULES §8](c:/yk-skill/rule/15_project_mgmt/PROJECT_DOCUMENT_RULES.md) — 旧 `01_product/` 等から吸収 · ルート `AGENTS.md` は stub 化 |

...
| ⑥ | 段階的提案の Go/No-Go（任意） | 試用期間・成功条件・判断者・報告形式 · [references/staged-rollout.md](references/staged-rollout.md) |
...
提案文書を書く前に [references/yk-tuning.md](references/yk-tuning.md) を Read。係長向け面談・方向性確認・外部 SaaS など、YK の職場で繰り返すパターンが載っている。
...
- 模範解答例 → [references/examples.md](references/examples.md)（YK・係長向けの現場ツール試用は **例4** を優先）
